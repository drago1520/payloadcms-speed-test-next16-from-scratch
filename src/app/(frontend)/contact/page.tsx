      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            type="text"
            required
            className="border-primary/20 bg-background w-full rounded-md border px-4 py-2"
          />
        </div>
  ...
  return (
    <form className="space-y-4" action={onSubmit}>
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <button
          type="submit"
          className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-md px-5 py-2 whitespace-nowrap transition-colors"
        >
          Subscribe
        </button>
      </div>
